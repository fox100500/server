...
//GetMarketStocks - Получение списка акций
func GetMarketStocks() ([]MarketInstrument, error) {
	reqName := "GetMarketStocks"
	...
	log.Println(reqName, "Total stocks", responce.Payload.Total)
	/*
